...
Start a new terminal in the directory of the current buffer
#+begin_src emacs-lisp :tangle yes
  (defun term-here ()
    (interactive)
    (start-process "" nil "gnome-terminal"))

  ;; (global-set-key (kbd "<f10>") 'term-here)
#+end_src
...
#+begin_src emacs-lisp :tangle yes
  (use-package writegood-mode
    ...
    :config
    (remove-hook 'yaml-mode-hook 'writegood-mode t)
    (remove-hook 'xml-mode-hook 'writegood-mode t)
    (remove-hook 'latex-mode-hook 'writegood-mode t))
#+end_src
